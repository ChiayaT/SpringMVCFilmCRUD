	...
	<c:choose>
      ...
      <br>
				...
				<form action="updateFilm.do" method="get">
					<h3>fill out the form and click update film to modify an
						existing field</h3>


					Title: <input required="required field" type="text" name="title"
						value="${film.title}"><br> Description: <input
						type="text" name="description" value="${film.description}"><br>
					Release Year: <input type="number" name="release_year"
						value="${film.releaseYear}"><br> Language_id: <select
						name="language_id">
					...
					</select> <br> Rental Duration: <input type="number"
						name="rental_duration" value="${film.rentalDuration}"><br>
					Rental Rate: <input type="number" name="rental_rate"
						value="${film.rentalRate}"><br> Length of Film: <input
						type="number" name="length" value="${film.length}"><br>
					Replacement Cost <input type="number" name="replacement_cost"
					...
					</select> <br> Features: <select name="features">
				...
				<a href="/MVCFilmSite/getFilm.do?delete=${film.id}"><button
						style="background-color: red; border-coler: black; color: white">
						Delete ${film.title }</button></a>
				<br>
			</c:forEach>
		</c:when>
		<c:otherwise>
      ...
      <br>
					...
					<form action="updateFilm.do" method="get">
						...
						<br> Title: <input type="text" name="title"
							value="${film.title}" required="required field"><br>
						Description: <input type="text" name="description"
							value="${film.description}"><br> Release Year: <input
							type="number" name="release_year" value="${film.releaseYear}"><br>
